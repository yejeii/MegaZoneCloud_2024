...
class EnumBase {
	static int idx = 0;	// 순서 정보에 활용되는 정보
	private int ordinal; 		// enum 내부 순서 정보
	String name = "";	// 상수명
